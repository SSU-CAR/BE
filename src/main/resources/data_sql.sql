insert into scenario (scenario_id, flag, name, weight, total) values (1, 1, '졸음 운전 (고개)', 5, 0);
insert into scenario (scenario_id, flag, name, weight, total) values (2, 1, '핸드폰 사용', 15, 0);
insert into scenario (scenario_id, flag, name, weight, total) values (3, 1, '졸음 운전 (눈)', 15, 0);
insert into scenario (scenario_id, flag, name, weight, total) values (51, 2, '방향지시등 안 켜고 차선변경', 7, 0);
insert into scenario (scenario_id, flag, name, weight, total) values (51, 2, '실선에서 차선변경', 7, 0);
